...
paru -S --needed --noconfirm ungoogled-chromium-bin dolphin konsole typora-free-with-plugin vesktop niri waybar rofi-wayland foot fastfetch ly networkmanager bluetui pipemixer satty btop neovim zsh firefox-developer-edition awww hyprlock grim slurp wl-clipboard cliphist cava starship mako hypridle ffmpeg jq brightnessctl playerctl rofi-rbw wtype obs-studio imagemagick kwallet kanshi ttf-jetbrains-mono ttf-roboto eza bat fzf zoxide ripgrep fd ttf-font-awesome ttf-meslo-nerd breeze breeze-icons plasma-integration power-profiles-daemon iwd iwgtk lazygit yazi tealdeer qimgv haruna ark okular bongocat libreoffice-still zapzap xcb-util-cursor tailscale
